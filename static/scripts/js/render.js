// var objPath = "{{ url_for('static', filename='scripts/export.obj') }}";
var scale = 2.5;
var INF = 100000000;
...
// var volume = document.getElementById("volume_value").innerText; 

if(document.getElementById("volume_value") != null){
    var volume=document.getElementById("volume_value").innerHTML;
}
...
function initScene() {
    ...
    var container = $("#container-second")[0];
...
function showOBJ(data) {
    ...
    console.log(xMin, xMax, yMin, yMax, zMin, zMax, volume);
...
function useDefaultData(objPath) {
    ...
    fileLoader.load(
        ...
        function (data, volume) { // onLoad callback
            $('#stats').html("obj file loaded.");
            showOBJ(data);
        },
